...
export default function EvaluationREBAForm(props) {
    ...
    useEffect(() => {
        let valores = [['/REBA/0.png', '/REBA/5.png'],
                    ['/REBA/1.png', '/REBA/6.png'],
                    ['/REBA/2.png', '/REBA/7.png'],
                    ['/REBA/3.png', '/REBA/8.png'],
                    ['/REBA/4.png', '/REBA/9.png']
                ];
